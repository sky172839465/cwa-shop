...
const preOrderHost = getEnvVar('VITE_AWS_COMMON_HOST_V2')
const orderHost = getEnvVar('VITE_AWS_COMMON_HOST_V2')
...
const Page = () => {
  ...
  return (
    <>
      <div
        className='m-auto h-auto overflow-x-auto max-lg:pb-24 max-lg:max-w-2xl max-sm:min-w-full lg:max-w-5xl'
      >
